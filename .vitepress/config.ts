...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a> © 2024-PRESENT psych-guide的贡献者们',
    },
    search: {
      provider: 'local',
      options: {
